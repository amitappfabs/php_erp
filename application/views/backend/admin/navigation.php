    ...
    <li> <a href="<?php echo base_url(); ?>admin/download_page" class="waves-effect"><i class="fa fa-download p-r-10"></i> <span class="hide-menu"><?php echo get_phrase('download_page');?> </span></a> </li>
